...
class CartController extends ClientController
{
    ...
    public function viewCart(Request $request)
    {
        ...
        $page_title = "Giỏ hàng";
        $this->breadcrumb->add($page_title, route('client.orders.cart'));
    ...
    public function viewBuyNowCart(Request $request)
    {
        ...
        if(!$cart) return redirect()->route('client.alert')->with('info', 'Hãy chọn một sản phảm bạn thích để thêm giỏ hàng');
        $page_title = "Mua ngay";
        $cart->type = 'buy-now';
