...
class CheckPasswordChange implements AuthenticatesSessions
{
    /**
    ...
    protected function logout($request)
    {
        ...
        if($request->is('admin/*')) $redirectTo = route('login');
        else $redirectTo = route('client.account.login');
        throw new AuthenticationException('Unauthenticated.', [$this->auth->getDefaultDriver()], $redirectTo);
    }
