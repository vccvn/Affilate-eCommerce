...
{
    const REF_KEY = 'attribute';
    
    public $table = 'attributes';
    public $fillable = [
        'category_id', 'category_map', 'name', 'label', 'input_type', 'value_type', 
        'advance_value_type', 'show_type', 'value_unit', 
        'is_required','is_unique', 'is_query', 'is_order_option', 'is_variant', 
        'has_price', 'price_type', 'use_list', 'use_thumbnail'
    ];
    ...
    public function toProductInputParam($product_id = 0) : array
    {
        $data = [
            ...
            '@use-thumbnail' => $this->use_thumbnail
        ];
