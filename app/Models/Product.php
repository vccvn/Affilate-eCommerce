...
class Product extends Model
{
    ...
    public $fillable = [
        'category_id', 'name', 'slug', 'type', 'description', 'detail', 'keywords',
        'featured_image', 'sku', 'price_status', 'list_price', 'sale_price', 'on_sale',
        'views', 'privacy',  'status', 'trashed_status', 'shop_id', 'created_by', 'category_map',
        'available_in_store'
    ];
