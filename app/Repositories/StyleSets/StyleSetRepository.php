 ...
 * 
 */
use App\Validators\StyleSets\StyleSetValidator;
use App\Masks\StyleSets\StyleSetMask;
use App\Masks\StyleSets\StyleSetCollection;
...
class StyleSetRepository extends BaseRepository
{
    ...
    {
        return \App\Models\StyleSet::class;
    }

    public function init()
    {
        $this->setJoinable([
            ['leftJoin', 'categories', 'categories.id', '=', 'style_sets.category_id']
        ])->setSelectable(['style_sets.*', 'category_name' => 'categories.name']);
     ...
     * @return array
     */
    public function getStyleSetTagData($request, array $args = [])
    {
