...
if(!function_exists('get_web_type')){
    ...
    function get_web_type(){
        try {
            return get_webconfig()->web_type??env('APP_WEB_TYPE', 'default');
        } catch (\Throwable $th) {
            //throw $th;
        }
        // $owner = get_owner();
        // $web_type = $owner?$owner->userWebSetting->web_type:env('APP_WEB_TYPE', 'default');
        return env('APP_WEB_TYPE', 'default');
    }
}
...
if(!function_exists('get_option')){
     ...
     * @param string $key
     * @param mixed $default
     * @return \App\Web\Options|\App\Web\Option|\Gomee\Helpers\Arr|string|float|integer
     */
...
if(!function_exists('get_setting')){
     ...
     * @param string $key
     * @param mixed $default
     * @return \App\Web\Options|\Gomee\Helpers\Arr|string|float|integer
     */
...
if(!function_exists('system_setting')){
     ...
     * @param string $key
     * @param mixed $default
     * @return \Gomee\Helpers\Arr|string|float|integer
     */
...
if(!function_exists('web_setting')){
    ...
    function web_setting($key = null, $default = null){
        ...
        if(!$web_setting) $web_setting = get_option('web')->config;
...
if(!function_exists('get_webconfig')){
     ...
     * @return \Gomee\Helpers\Arr|string|float|integer
     */
    function get_webconfig($key = null, $default = null){
        static $web_setting = null;
        if(!$web_setting) $web_setting = get_option('web')->config;
