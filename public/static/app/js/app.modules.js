        ...
        App.task(function ($) {
            ...
            var CrazySelect = function (selector, template) {
                ...
                this.init = function () {
                    ...
                    $(document).on('click', function (e) {
                        ...
                        if (!$e.closest(self.$el).length) {
                            self.hide();
                        } else if ($e.is(self.$select) || $e.closest(self.$select).length) {
                            self.toggle();
                        }
                ...
                this.ajaxSearch = function (keyword, callback) {
                    ...
                    App.api.get(this.searchUrl, data).then(function (rs) {
                        if (rs.status) {
                            if (rs.data) {
                                self.hideLoader();
                                // do something
                ...
                orders: {
                    ...
                    cancel: function (id, code, success) {
                        App.api.post(this.urls.cancel, { id: id }).then(function (result) {
                            if (result.status) {
                                App.Swal.alert("Đã hủy đơn hàng " + code + " thành công!", null, function () {
                                    top.location.reload();
                                });
                                $('#order-item-' + id + ' .order-status').html('Đã huỷ')
