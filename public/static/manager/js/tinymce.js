...
function addTinymceEditor($content) {
    ...
    var options = {
        selector: 'textarea#' + $content.attr('id'),
        branding: false,
        language: "vi",
        height: h,
        plugins: [
            'print preview powerpaste importcss searchreplace autolink autosave save directionality ',
            'visualblocks visualchars fullscreen image link media  template codesample table toc ',
        ...
        mobile: {
            plugins: 'forecolor backcolor print preview powerpaste importcss searchreplace autolink autosave save directionality visualblocks visualchars fullscreen image link media  template codesample table charmap hr pagebreak nonbreaking anchor toc insertdatetime advlist lists  wordcount  a11ychecker textpattern noneditable help formatpainter charmap mentions emoticons openGallery'
        },
        image_advtab: true,
        relative_urls: false,
        ...
        contextmenu: 'bold italic underline | alignleft aligncenter alignright alignjustify | forecolor backcolor | link',
        content_css: [
        ...
        toolbar: "undo redo | formatselect | bold italic underline formatgroup | forecolor backcolor | alignleft aligncenter alignright | paragraphgroup | toc | table link image media emoticons insertgroup",
        toolbar_groups: {
            formatgroup: {
                icon: 'format',
                tooltip: 'Định dạng',
