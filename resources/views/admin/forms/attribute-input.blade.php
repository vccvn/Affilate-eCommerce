...
<div class="scope-{{$input->hiddenData('scope')}} {{$input->error?'has-danger':''}}" id="{{$input->id }}-form-group">
    <div class="">
                        ...
                        <div id="product-variant-value-{{$value}}" class="variant-attribute-item">
                            ...
                            <div class="variant-option {{$checked?'show':''}}">
                                ...
                                <div class="crazy-form-group row {{$priceError?'has-danger':''}}">
                                    <label for="variant-price-{{$attr_id}}-{{$value}}" class="col-12 col-sm-6 col-md-6 col-lg-5 col-form-label">
                                ...
                                @if ($advance_value_type == 'image')
                                    ...
                                    <div class="crazy-form-group row mt-2 {{$imgError?'has-danger':''}}">
                                        <label for="variant-images-{{$attr_id}}-{{$value}}" class="col-12 col-sm-6 col-md-6 col-lg-5 col-form-label">
                                            Ảnh đính kèm
                                        </label>
                                ...
                                @elseif ($advance_value_type == 'color')
                                    ...
                                    <div class="crazy-form-group row mt-2 {{$clrError?'has-danger':''}}">
                                        <label for="variant-color-{{$attr_id}}-{{$value}}" class="col-12 col-sm-6 col-md-6 col-lg-5 col-form-label">
                                            Mã màu
                                        </label>
                                        <div class="col-12 col-sm-6 col-md-6 col-lg-4">
                                            @include($_base.'forms.templates.coloris', [
                                                'input' => html_input([
                                                    'type' => 'text',
