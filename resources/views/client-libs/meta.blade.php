...
?>
    ...
    @endphp
    <!-- seo -->
    <link rel="canonical" href="{{$full_url = str_replace('http://', 'https://', $canonical)}}" />
    ...
    <script type="application/ld+json">{!! json_encode($helper->getBreadcrumbSchemaJson()) !!}
    </script>
