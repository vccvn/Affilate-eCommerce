<div class="menu-right">
    <ul>
        ...
        <li class="onhover-dropdown cart-dropdown">
            ...
            <a href="{{route('client.orders.cart')}}" class="btn btn-outline-default btn-spacing btn-cart d-none d-xl-flex header-btn-cart">
                
                <img src="{{theme_asset('images/header/cart.png')}}" alt="">
                <span class="{{parse_classname('cart-quantity')}}">0</span>
            </a>
            <a href="{{route('client.orders.cart')}}" class="btn-cart cart-icon d-xl-none primary-color mobile-btn header-btn-cart">
        ...
        <li class="onhover-dropdown df-lg-none" id="account-menu-block">
            ...
            <div class="onhover-div profile-dropdown">
                <ul id="account-menu-links">
                    @if ($user)
                    <li>
                        <a href="{{route('client.account')}}" class="d-block">Trang cá nhân</a>
                    </li>
                    <li>
