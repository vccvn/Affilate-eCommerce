                                    ...
                                    <div class="row">
                                        <div class="col-sm-6 col-md-5 col-lg-4">
                                            <div class="text-center">
                                                @if (substr($QR_Image, 0, 5) == '<'.'?xml')
                                                    {{-- {!! $QR_Image !!} --}}
                                                    <img src="data:image/svg+xml;base64,{{ base64_encode($QR_Image) }}" style="max-width: 100%">
                                                @else
                        ...
                        <div class="row g2fa-app">
                            ...
                            <div class="col-6">
                                <a href="https://apps.apple.com/us/app/google-authenticator/id388497605">
                                    <img src="{{asset('static/manager/assets/images/vn-badge-ios.png')}}" alt="">
                                </a>
                            </div>
                            <div class="col-6">
                                <a href="https://play.google.com/store/apps/details?id=com.google.android.apps.authenticator2&hl=vi">
                                    <img src="{{asset('static/manager/assets/images/vi_badge_web_generic.png')}}" alt="">
                                </a>
                            </div>
                        </div>
					</div>
