            ...
            <form action="" method="get" class="filter-form">
                <div class="form-group row mb-0">
                    ...
                    <div class="col-sm-6 col-md-2">
                        <?php echo $__env->make($_base.'forms.templates.crazyselect', [
                            'input' => html_input([
                                'type' => 'crazyselect',
                                'name' => 'category',
...
<?php /**PATH /Users/doanln/Desktop/VCC Corp/mien-atelier/resources/views/admin/_templates/list-filter-product.blade.php ENDPATH**/ ?>