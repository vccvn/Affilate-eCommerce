        ...
        <div class="m-portlet__head-tools">
            <ul class="m-portlet__nav">
                <li class="m-portlet__nav-item">
                    <a href="<?php echo e(admin_dynamic_url('create')); ?>" data-toggle="m-tooltip" data-placement="left" title data-original-title="Thêm <?php echo e($dynamic->name); ?>" class="ml-3 btn btn-outline-primary m-btn m-btn--icon btn-sm m-btn--icon-only m-btn--pill m-btn--air"><i class="fa fa-plus"></i></a>
                </li>
            </ul>
        </div>
        <?php endif; ?>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr id="crazy-item-<?php echo e($item->id); ?>" data-name="<?php echo e($item->title); ?>">
                                <td class="check-col">
                                    <label class="m-checkbox m-checkbox--solid m-checkbox--success">
                                ...
                                <td>
                                    <a style="font-weight:500" href="<?php echo e($url = admin_dynamic_url('update', ['id'=>$item->id])); ?>">
                                        <img src="<?php echo e($item->getThumbnail()); ?>" class="image-thumbnail" alt="<?php echo e($item->title); ?>">
                                    </a>
                                </td>
                                <td class="min-160 max-250"><a href="<?php echo e($url); ?>"><?php echo e($item->title); ?></a></td>
                                <?php if($dynamic->use_category): ?>
                                    <th><?php echo e($item->category?$item->category->name:"Không"); ?></th>
                                <?php endif; ?>
                                <td class="min-160 max-250"><?php echo e($item->getShortDesc(150)); ?></td>
                                <td class="min-100 actions">


                                    <a data-toggle="m-tooltip" data-placement="left" title data-original-title="Sửa" href="<?php echo e($url); ?>" class="text-accent btn btn-outline-accent btn-sm m-btn m-btn--icon m-btn--icon-only m-btn--pill m-btn--air">
...
<?php /**PATH /Users/doanln/Desktop/VCC Corp/mien-atelier/resources/views/admin/posts/templates/results.blade.php ENDPATH**/ ?>