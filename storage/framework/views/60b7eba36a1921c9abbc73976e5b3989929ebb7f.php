...
<head>
    ...
    <title>404 - Không tìm thấy trang | <?php echo e(siteinfo('site_name')); ?></title>
    <link rel="stylesheet" href="<?php echo e(asset('static/system/errors/404/style.min.css')); ?>">
</head>
<body>
    <?php
    ...
    <div class="not-found parallax">
        ...
        <a class="wave-island" href="<?php echo e(request()->is('admin/*')?route('admin.dashboard'):route('home')); ?>">
    ...
    <script src="<?php echo e(asset('static/system/errors/404/script.js')); ?>"></script>
</body>
</html><?php /**PATH /Users/doanln/Desktop/VCC Corp/mien-atelier/resources/views/errors/404.blade.php ENDPATH**/ ?>