	...
	'action'                   => function($item, $link, $sub)
	{
		...
		if($item->isActive()){
			if(!$item->hasSubMenu()){
				...
				$item->addClass('m-menu__item--active m-menu__item--expanded m-menu__item--open');
			}
...
?>
				...
				<div id="m_aside_left" class="m-grid__item	m-aside-left  m-aside-left--skin-dark">
					...
					<!-- END: Aside Menu -->
				</div><?php /**PATH /Users/doanln/Desktop/VCC Corp/mien-atelier/resources/views/admin/_components/sidebar.blade.php ENDPATH**/ ?>