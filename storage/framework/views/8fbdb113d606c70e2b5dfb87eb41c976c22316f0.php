...
<?php $__env->startSection('title', $page_title = isset($title)?$title:"Đăng nhập hệ thống"); ?>
				...
				<div class="m-grid__item m-grid__item--fluid	m-login__wrapper">
					<div class="m-login__container">
						<div class="m-login__logo">
							<a href="#">
								<img src="<?php echo e(siteinfo('admin_login_logo', asset('static/images/logos/login_logo.png'))); ?>">
							</a>
						</div>
						<div class="m-login__signin">
							...
							<form class="m-login__form m-form" action="<?php echo e(route('post-login')); ?>" method="POST">
						...
						<div class="m-login__signup">
							...
							<form class="m-login__form m-form" action="<?php echo e(route('password.reset.save')); ?>" method="POST">
								<input type="hidden" name="token" value="<?php echo e(isset($token)?$token:uniqid()); ?>">
								<div class="form-group m-form__group">
						...
						<div class="m-login__forget-password">
							...
							<form class="m-login__form m-form" action="<?php echo e(route('post-forgot')); ?>" method="POST">
								<div class="form-group m-form__group">
...
<?php $__env->startSection('js'); ?>
	<script src="<?php echo e(asset('static/manager/js/login.js')); ?>" type="text/javascript"></script>
	
<?php $__env->stopSection(); ?>
<?php echo $__env->make($_layout.'auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/doanln/Desktop/VCC Corp/mien-atelier/resources/views/admin/auth/login.blade.php ENDPATH**/ ?>