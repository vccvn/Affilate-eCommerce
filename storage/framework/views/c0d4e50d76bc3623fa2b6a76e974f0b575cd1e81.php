...
<div <?php echo $wrapper->attrsToStr(); ?>>
    ...
    <div class="gallery-hidden-input-group d-none">
        <?php if(count($gallery)): ?>
            <?php $__currentLoopData = $gallery; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <input type="hidden" name="<?php echo e($baseName.'[]'); ?>" value="<?php echo e($file->id); ?>" id="hidden-input-gallery-image-<?php echo e($file->id); ?>">
    ...
    <div class="gallery-images">
        <?php if(count($gallery)): ?>
            <?php $__currentLoopData = $gallery; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <div class="dz-preview dz-image-preview" id="input-gallery-image-<?php echo e($file->id); ?>">
                    <div class="dz-image">
                        <img data-dz-thumbnail="" alt="<?php echo e($file->filename); ?>" src="<?php echo e($file->getThumbnail()); ?>">
                    </div>
                    <div class="dz-details">
                        <div class="dz-size"><span><strong><?php echo e($sizeinfo['size']); ?></strong> <?php echo e($sizeinfo['size_unit']); ?></span></div>
                        <div class="dz-filename">
                            <span data-dz-name="<?php echo e($file->filename); ?>"><?php echo e($file->filename); ?></span>
                        </div>
                    </div>
                    <a class="dz-remove btn-remove-file" data-id="<?php echo e($file->id); ?>" href="javascript:undefined;">
            ...
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        <?php endif; ?>
        <div class="dz-preview dz-image-preview button-add" id="input-gallery-add-button">
            <div class="dz-image">
                <img data-dz-thumbnail="" alt="Thêm ảnh" src="<?php echo e(asset('static/manager/assets/images/plus-icon.png')); ?>">
            </div>
            <div class="dz-details">
                <div class="dz-size"><span data-dz-size="">Thêm ảnh</span></div>
                <div class="dz-filename">
                    <span data-dz-name="add-btn">Thư viện ảnh</span>
                </div>
            </div>
        </div>
...
<?php /**PATH /Users/doanln/Desktop/VCC Corp/mien-atelier/resources/views/admin/forms/templates/gallery.blade.php ENDPATH**/ ?>